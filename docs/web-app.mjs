...
import { importObject, setWasmExports } from './web-app.import-object.mjs'
...
const wasmFilePath = './web-app.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./web-app.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
